...
namespace TiendaApi.Controllers
{
        ...
        {
            public readonly IDTiendas _Dtiendas;
            public TiendaController(IDTiendas dtiendas)
            {
                _Dtiendas = dtiendas;
            }
            [HttpGet]
            public async Task<Mrespuesta> Get()
            {
                ...
                try
                {
                    response.Datos = _Dtiendas.MostrarTiendas().Result;
            ...
            //    try
            //    {
            //        long codigoRespuesta = _Dtiendas.InsertarProductos(PRODUCTOS).Result;
